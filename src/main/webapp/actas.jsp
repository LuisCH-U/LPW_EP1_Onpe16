                    ...
                    <div class="col-xs-12 col-md-3">
                        <div class="menu-interna">
                            <ul>
                                ...
                                <li><a href="actas.jsp" class="act-izq">Actas por número</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xs-12 col-md-9" id="impreso">
                        <div class="contenido-interna">
                            ...
                            <div class="col-xs-12">
								...
								<p>&nbsp;</p>
								<p>&nbsp;</p>
								    <form id="myfsorm" name="myform" class="horizontal-form" method="post" action="javascript:actas_bscarPrNmroMesa(document.getElementById('myform'));">
											<div class="col-md-3">
										...
										<% if ( id == null && data == null ){ %>
											...
											<div class="col-md-2">
												<button type="button" onclick="btnbuscar" class="btn btn-primary"><span class="glyphicon glyphicon-search" aria-hidden="true"></span> BUSCAR</button>
											</div>
											 <%} %>
                           ...
                           <% if ( id == null && data != null){ %>
                        	...
                        	<% } %>
								...
								<div id="divDetalle" class="ptop30">
								</div>
                            </div>
														...
														<table class="table06">
															...
															<tr class="titulo_tabla">
																...
																<td>Total de Votos</td>
																	...
																	<td><img width="40px" height="40px" src="images/00000114.jpg"></td>
																	<td>76</td>
																</tr>
																																																																							<tr>
																	<td>FUERZA POPULAR</td>
																	<td><img width="40px" height="40px" src="images/00000106.jpg"></td>
																	<td>174</td>
																</tr>
																<tr>
